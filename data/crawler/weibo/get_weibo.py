...
Cookie = 'SINAGLOBAL=4425100300041.554.1666339903107; UOR=,,www.baidu.com; ULV=1674901578337:5:1:1:7285644935288.193.1674901578268:1669468330256; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9W5shDzPXr8DRKPNvuCBnVCV5JpX5KMhUgL.FoM01K5N1hn0Shn2dJLoIp7LxKML1KBLBKnLxKqL1hnLBoMNe0.7S0nRe0BR; ALF=1678102411; SSOLoginState=1675510413; SCF=AmZZ1EK-9qm544rLpMROtBcL9b5_mQUnl8xpA1-qLiyhMpIAENV-lD_oqQejEukX-5SSm2hRrAsg-BkNJT6otDk.; SUB=_2A25O2jLfDeRhGeFN4lIW-CbPzzSIHXVtriMXrDV8PUNbmtANLUf7kW9NQ6gTOGojPhd5wxlHhihf0A85XsfeR-w1; XSRF-TOKEN=HmHLcTv_ExiLr7XyHGakLmQY; WBPSESS=B1lLmkVAyacRHLi7qqvuxbUo4JjP3FXc-EjU09eQPipawD62aOaEB0wun3uvIdY9ETa4Xjtx39QoSbYhEmPB1IxvXs1EvvO8x633K3rOJtcnYVrQ3Vfr085nPqj905RC3J0SItfe1ZaaSACgxstMcQ=='
...
if __name__ == '__main__':
    ...
    # start_time + 8hour
    start_time, end_time = '2020-10-31-04', '2022-10-31-05'
    if start_time >= end_time:
        raise Exception('start_time 是离现在更远的那个时间，必须小于 end_time')
    WeiboTopicScrapy(keyword=keyword, filter=0, start_time=start_time, end_time=end_time)