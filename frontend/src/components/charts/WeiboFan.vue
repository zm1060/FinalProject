...
export default {
  ...
  data() {
    return {
      images: {},
      tabs: [
        { key: 'gender_counts', title: '粉丝性别分布' },
        { key: 'location_counts', title: '粉丝位置分布' },
        { key: 'gender_location_counts', title: '粉丝的性别和位置分布' },
        { key: 'age_distribution', title: '粉丝年龄分布' },
        { key: 'top_interests', title: '粉丝感兴趣话题' },
        { key: 'influence_distribution', title: '粉丝影响力' },
      ],
      visibleTabs: {
        gender_counts: false,
