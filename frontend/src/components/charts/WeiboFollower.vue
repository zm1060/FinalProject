...
export default {
  ...
  data() {
    return {
      images: {},
      tabs: [
        { key: 'gender_counts', title: '关注者性别分布' },
        { key: 'location_counts', title: '关注者位置分布' },
        { key: 'gender_location_counts', title: '关注者的性别和位置分布' },
        { key: 'age_distribution', title: '关注者年龄分布' },
        { key: 'top_interests', title: '关注者的兴趣分布' },
        { key: 'influence_distribution', title: '关注者影响力' },
      ],
      visibleTabs: {
        gender_counts: false,
        location_counts: false,
        gender_location_counts: false,
        age_distribution: false,
        top_interests: false,
        influence_distribution: false,
      },
    }
  },
  methods: {
