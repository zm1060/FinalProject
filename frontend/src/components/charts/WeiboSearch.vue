  ...
  data() {
    return {
      ...
      tabs: [
        ...
        { key: 'time_series', title: '博文发布频率' },
        { key: 'user_engagement', title: '博文用户参与度' },
        { key: 'hashtag_frequency', title: '博文标签频率' },
        { key: 'topic_distribution', title: '博文的话题分布' },
        { key: 'post_sources', title: '博文发布源分布' },
      ],
      visibleTabs: {
        sentiment_histogram: false,
        time_series: false,
        user_engagement: false,
        hashtag_frequency: false,
